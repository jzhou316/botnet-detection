...
The datasets are a collection of different botnet topologyies overlaid onto real network traffics, containing graphs of relatively large scale and totally featureless.
